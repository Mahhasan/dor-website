...
class DataController extends Controller
{
    ...
    // For Admin
    public function admin_scopus_article()
    {
		$client = new Client(); //GuzzleHttp\Client
        $url = "https://pd.daffodilvarsity.edu.bd/fgs/repository";
        $response = $client->request('GET', $url, [
		...
		return view('backend.scopus_article',compact('responseBody'));
    }
    public function admin_scopus_article_details($id)
    {
		$client = new Client(); //GuzzleHttp\Client
        $url = "https://pd.daffodilvarsity.edu.bd/fgs/repository/$id";
        $response = $client->request('GET', $url, [
		...
		return view('backend.scopus_article_details',compact('responseBody'));
    }
}