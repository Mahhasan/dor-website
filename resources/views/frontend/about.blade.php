...
<section class="cta">
    <div class="container">
        <div class="row p-4" style="background-color:#f2f2f2">
            <h4 class="text-center pb-5" style="font-family: Century Gothic;">Message from The Director</h4>
            <p><img class="d-block mx-auto" src="images/director.jpg" alt=""></p>     
            <div class="cta-block">
                <p class="text-justify" style="font-family: Century Gothic;">
                    ...
                    This site will be resourceful gradually in course of time. <br><br>
                    Professor Dr. Md Kabirul Islam <br>
                    Dean, Faculty of Graduate Studies (FGS) <br>
