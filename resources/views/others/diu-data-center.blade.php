        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title text-center">
                    <h3>DIU Data Center</h3>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="gallery-item">
                    <img src="https://it.daffodilvarsity.edu.bd/wp-content/uploads/2019/01/DataCenter.jpg" class="img-responsive" style="width:360px; height:250px;" alt="gallery-image">
                    <a data-fancybox="images" href="https://it.daffodilvarsity.edu.bd/wp-content/uploads/2019/01/DataCenter.jpg"></a>
                    <p></p>
                </div>
            </div>
        </div>
